...
execute if score #filter-transfer# __shoukadp__ matches 0 run tag @s remove filter-valid
execute if score #filter-transfer# __shoukadp__ matches 1 run tag @s add filter-valid
