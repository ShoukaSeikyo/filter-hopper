...
execute if entity @s[nbt={Rotation:[271.0f,0f]}] run setblock ~ ~ ~ minecraft:hopper[facing=south]{CustomName:'{"text":"Filter Hopper"}',TransferCooldown:8s} replace
execute if entity @s[nbt={Rotation:[90.0f,10f]}] run setblock ~ ~ ~ minecraft:hopper[facing=north]{CustomName:'{"text":"Filter Hopper"}',TransferCooldown:8s} replace
execute if entity @s[nbt={Rotation:[183.0f,0f]}] run setblock ~ ~ ~ minecraft:hopper[facing=south]{CustomName:'{"text":"Filter Hopper"}',TransferCooldown:8s} replace
execute if entity @s[nbt={Rotation:[4.0f,0f]}] run setblock ~ ~ ~ minecraft:hopper[facing=north]{CustomName:'{"text":"Filter Hopper"}',TransferCooldown:8s} replace
